...
export const getQuizzes = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    return next(new ErrorResponse('Failed to fetch quizzes', 500));
  }
});
...
export const getQuiz = asyncHandler(async (req, res, next) => {
  try {
    ...
    return next(new ErrorResponse('Failed to fetch quiz', 500));
  }
});
...
export const getQuizAttempts = asyncHandler(async (req, res, next) => {
  try {
    ...
    return next(new ErrorResponse('Failed to fetch quiz attempts', 500));
  }
});
...
export const getMyQuizAttempt = asyncHandler(async (req, res, next) => {
  try {
    ...
    return next(new ErrorResponse('Failed to fetch quiz attempt', 500));
  }
});
...
export const getQuizStats = asyncHandler(async (req, res, next) => {
  try {
    ...
    return next(new ErrorResponse('Failed to fetch quiz statistics', 500));
  }
});